...
import org.groebl.smsmms.data.RecipientIdCache;
            ...
            activity.runOnUiThread(new Runnable() {
                public void run() {
                    new AlertDialog.Builder(activity)
                        ...
                        .setTitle(org.groebl.smsmms.R.string.error_state)
                        .setMessage(msg + "\n\n" + activity.getString(org.groebl.smsmms.R.string.error_state_text))
                        .setPositiveButton(org.groebl.smsmms.R.string.yes, new OnClickListener() {

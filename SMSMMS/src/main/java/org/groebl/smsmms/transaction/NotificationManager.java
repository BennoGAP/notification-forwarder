...
import org.groebl.smsmms.receiver.WearableIntentReceiver;
...
public class NotificationManager {
    ...
    public static final String ACTION_MARK_READ = "org.groebl.smsmms.MARK_READ";
    public static final String ACTION_MARK_SEEN = "org.groebl.smsmms.MARK_SEEN";
    ...
    private static void singleSender(final Context context, ArrayList<MessageItem> messages, long threadId,
        ...
        if (privateNotifications == 2) notificationTitle = "SMS";

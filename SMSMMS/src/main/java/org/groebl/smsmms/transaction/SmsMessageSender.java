...
import org.groebl.smsmms.receiver.SmsReceiver;
...
public class SmsMessageSender implements MessageSender {
    ...
    private boolean queueMessage(long token) throws MmsException {
        ...
        mContext.sendBroadcast(new Intent("org.groebl.smsmms.transaction.SEND_MESSAGE", null, mContext, SmsReceiver.class));
        return false;
    }

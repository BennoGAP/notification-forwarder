...
import org.groebl.smsmms.common.TypefaceManager;
import org.groebl.smsmms.common.utils.TextUtils;
...
public class QKTextView extends TextView {
    ...
    public void setType(int type) {
        ...
        if (mType == FontManager.TEXT_TYPE_CATEGORY) {
            LiveViewManager.registerView(org.groebl.smsmms.enums.QKPreference.THEME, this, key ->
                    setTextColor(FontManager.getTextColor(mContext, mType)));
        }
        ...
        }, org.groebl.smsmms.enums.QKPreference.FONT_FAMILY, org.groebl.smsmms.enums.QKPreference.FONT_WEIGHT);

        LiveViewManager.registerView(org.groebl.smsmms.enums.QKPreference.FONT_SIZE, this, key -> {
            setTextSize(TypedValue.COMPLEX_UNIT_SP, FontManager.getTextSize(mContext, mType));
        });

        LiveViewManager.registerView(org.groebl.smsmms.enums.QKPreference.BACKGROUND, this, key -> {
            setTextColor(FontManager.getTextColor(mContext, mType));
        });

        LiveViewManager.registerView(org.groebl.smsmms.enums.QKPreference.TEXT_FORMATTING, this, key -> {

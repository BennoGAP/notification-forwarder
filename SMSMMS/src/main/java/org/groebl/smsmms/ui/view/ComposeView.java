...
import org.groebl.smsmms.interfaces.RecipientProvider;
import org.groebl.smsmms.common.utils.ImageUtils;
...
public class ComposeView extends LinearLayout implements View.OnClickListener {
    ...
    public void sendSms() {
        ...
        if (recipients != null && recipients.length > 0) {
            ...
            org.groebl.smsmms.mmssms.Message message = new org.groebl.smsmms.mmssms.Message(body, recipients);
            message.setType(org.groebl.smsmms.mmssms.Message.TYPE_SMSMMS);
            if (attachment != null) {
